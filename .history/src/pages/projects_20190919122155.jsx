  ...
  <Row className="Project_Section mx-auto px-auto">
    ...
    <Col md="auto" className="Project_Section--right text-center">
      ...
      <div className="Project_Desc">
       ...
       This program is a basic web crawler that is designed and implementmented to have two primary functions. The crawler navigates from a “starting url” to a “listing page” on the amazon website. It collects a small number of specified attributes on the page that relates to the book's product description.
        <div className="Project_Dec--codeLink">
          <a
            href="https://github.com/monicamarroyo/Monica_Salon_React"
            target="_blank"
