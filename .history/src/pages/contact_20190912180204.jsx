...
const Contact = ({ data }) => (
  <Row className="Contact_Section mx-auto px-auto">
    <BackgroundImage
      ...
      className="bgFly"
    >
      <Col md="auto" sm="12" className="Contact_Section--left mx-auto my-auto px-auto py-auto">
        <div className="Contact_Info">
          <h1 className="Contact_Info--text mx-auto my-auto px-auto py-auto">Contact</h1>
    ...
    <Col md="auto" className="Contact_Section--right mx-auto my-auto px-auto py-auto">
