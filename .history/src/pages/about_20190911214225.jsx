      ...
      <Col md="auto" className="about_right text-center">
        ...
        <form id="email-form" name="email-form" data-name="Email Form">
          ...
          <input type="text" class="input contact-input w-input" maxlength="256" name="Name" data-name="Name" placeholder="Your name" id="Name" required="">
            <label for="Email" class="contact-form-label">Email:</label><input type="email" class="input contact-input w-input" maxlength="256" name="email" data-name="Email" placeholder="Email address" id="Email" required=""><label for="Message" class="contact-form-label">Message:</label><textarea id="Message" name="Message" maxlength="5000" data-name="Message" required="" placeholder="Tell me about your project" class="input contact-input text-field w-input"></textarea><input type="submit" value="Send Message" data-wait="Please wait..." class="button big color-3 w-button"></form>
        </div>
