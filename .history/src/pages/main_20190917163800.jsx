...
const Main = ({ data }) => (
  <BackgroundImage Tag="section" className="Main_Section--bg" fluid={data.bgMountain.childImageSharp.fluid}>
    <Row className="Main_Section text-center">
      <Col className="mx-auto px-auto py-auto my-auto">
        <Heading size={4} className="Main_Section--text1 text-center pt-2 pb-0">
          {" "}
          Monica Arroyo
        </Heading>
        <Heading
    ...
    <Row className="text-center" style={{backgroundColor:"rgba(0, 0, 0, .3)"}}>
      <a
...
const MainSection = props => (
  <StaticQuery
    query={graphql`
      query MyQuery6 {
        bgMountain: file(relativePath: { eq: "austin-img-2.png" }) {
          childImageSharp {
