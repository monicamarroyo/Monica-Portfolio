      ...
      <Fade bottom>
        <Row className="pb-2">
          <Col className="text-center">
            <h4 className="header-text_name"> Monica Arroyo</h4>
            <h1 className="header-text_desc double-underline pb-2">
              WEB DEVELOPER
            </h1>
            <Navbar
              expand="sm"
              className="d-none d-md-block d-lg-block d-xl-block text-center"
            >
              <NavScrollspy
