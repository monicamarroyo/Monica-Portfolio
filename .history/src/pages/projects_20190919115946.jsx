  ...
  <Row className="Project_Section mx-auto px-auto">
    ...
    <Col md="auto" className="Project_Section--right text-center">
      ...
      <div className="Project_Desc">
        ...
        on Front-End development. Since then I have continued
        to program in React, and it's a framework that I enjoy programming in.
      ...
      <div className="Project_Desc">
        <h5 className="Project_Title">Amazon Web Crawler</h5>I created this
