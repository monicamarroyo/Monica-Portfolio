...
const Main = ({ data }) => (
  <BackgroundImage Tag="section" fluid={data.bgMountain.childImageSharp.fluid}>
    <Row className="Main_Section text-center">
      <div className="Main_Section_Text2 px-auto mx-auto py-auto my-auto text-center">
        <h3>Monica Arroyo</h3>
      </div>
      <div>
        <h1 className="Main_Section_Text2 px-auto mx-auto py-auto my-auto text-center">
          Web developer
        </h1>
      </div>
    </Row>
