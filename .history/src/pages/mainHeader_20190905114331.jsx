      ...
      <Fade bottom>
        <Row className="pb-5">
          <Col className="text-center">
            <div className="header-text_name">
              {" "}
              Monica Arroyo
            </div>
            <div
              
              className="header-text_desc double-underline pb-2"
            >
              WEB DEVELOPER
            </h1>
            <Navbar expand="sm" className="d-none d-md-block d-lg-block d-xl-block text-center">
              <NavScrollspy
