  ...
  return (
    <Container className="px-5 mx-auto">
      <Fade bottom>
        <Row>
          <Col className="text-center">
            ...
            <Navbar expand="sm" className="d-none d-sm-flex mt-4">
              <NavScrollspy
      ...
      <Row className="text-center">
        ...
        <span className="social-icons_spinner">
        <SocialLink icon="github" to="https://www.linkedin.com/in/monica-arroyo-765b7111a/" />
          
        </span>
         
          <SocialLink icon="github" to="https://github.com/monicamarroyo" />
          <SocialLink icon="github" to="https://instagram.com" />
        </div>
      </Row>
    </Container>
  )
