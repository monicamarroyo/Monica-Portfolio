...
const Main = ({ data }) => (
  <BackgroundImage Tag="section" fluid={data.bgMountain.childImageSharp.fluid}>
    ...
    <Row className="text-center">
      <a
        className="Main_Section--desc d-inline"
        href="https://drive.google.com/file/d/1nbZps9HBHTAuDymwGDa5-lcCqPYURswW/view"
        target="_blank"
      >
        <div className="Main_Section--btn" />
        <div className="header-btn_icon">
          <MdToys className="header-icon_star" />
        </div>
        <div className="Main_Secttion--btnText text-nowrap">View My Resume</div>
      </a>
      <div className="Main_Section--socialIcons mx-auto pt-3">
        <SocialLink
          icon="linkedin"
