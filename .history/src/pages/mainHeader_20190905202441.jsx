  ...
  return (
    <Container className="px-5 mx-auto">
      <Fade bottom>
        <Row>
          <Col className="text-center">
            <Heading size={4} className="header-text_name pb-0"> Monica Arroyo</Heading>
            <Heading size={1} className="header-text_desc double-underline">
              WEB DEVELOPER
            </Heading>
            <Navbar
            expand="sm"
             className="d-none d-sm-flex mt-4"
            >
              <NavScrollspy
                ...
                mapItems={({ name, href }) => (
                  <NavItem
                    ...
                    key={name}
                  >
                    <AnchorLink className="nav-link nav-link-main" href={`#${href}`}>
                      {name}
                    </AnchorLink>
                  </NavItem>
                )}
      ...
      <Row className="header_links text-center">
        ...
        >
          <div className="" />
          <Icon className="header-btn_icon" name="envelope" />
