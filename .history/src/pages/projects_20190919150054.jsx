    ...
    <Col md="auto" className="Project_Section--right text-center">
      ...
      <div className="Project_Desc">
        ...
        <div className="Project_Libraries text-center d-none d-xl-block d-lg-block d-md-block ">
          <SocialLink icon="graphql" to="https://reactjs.org/" />
          <SocialLink icon="prismic" to="https://sass-lang.com/" />
          <SocialLink icon="postgresql" to="https://getbootstrap.com/" />
          <SocialLink icon="node-dot-js" to="https://csswizardry.com/" />
