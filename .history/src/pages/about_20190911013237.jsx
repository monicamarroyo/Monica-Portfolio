    ...
    <Row className="about_container">
      ...
      >
        <Col md="auto" sm="12" className="about_left">
          ...
          <div className="about_contact d-none d-xl-block d-lg-block d-md-block d-flex align-items-end">
            <div>Austin TX 78744</div>
            <div>(512) 825-2633</div>
            <div>monica.arroyo1319@gmail.com</div>
          </div>
      ...
      <Col md="auto" className="about_right">
        <CustomScroll className="d-none d-xl-block d-lg-block d-md-block">
          <div>this is where I get to put my shit</div>
        </CustomScroll>
      </Col>
