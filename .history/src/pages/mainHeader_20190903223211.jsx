...
const MainHeader = () => {
  return (
    <Container>
      ...
      <Row className="header-btn text-center">
        
        <a className="header-btn_icon" href="https://drive.google.com/file/d/1nbZps9HBHTAuDymwGDa5-lcCqPYURswW/view" target="_blank">
          <Icon className="header-btn_icon_env" name="envelope"/>
          
        </a>
        <a className="header-btn-text" href="https://drive.google.com/file/d/1nbZps9HBHTAuDymwGDa5-lcCqPYURswW/view" target="_blank">
         View My Resume
        </a>
