    ...
    <Col md="auto" className="Project_Section--right text-center">
      ...
      <div className="Project_Desc">
        ...
        <div className="Project_Libraries text-center d-none d-xl-block d-lg-block d-md-block ">
          ...
          <SocialLink icon="visualstudiocode" to="https://material.io/design/" />
        </div>
      </div>
      <div className="Project_Desc2">
        ...
        <div className="Project_Libraries text-center d-none d-xl-block d-lg-block d-md-block ">
          <SocialLink icon="node-dot-js" to="https://reactjs.org/" />
          <SocialLink icon="npm" to="https://sass-lang.com/" />
          <SocialLink icon="javascript" to="https://getbootstrap.com/" />
          <SocialLink icon="json" to="https://csswizardry.com/" />
          <SocialLink icon="visualstudiocode" to="https://material.io/design/" />
        </div>
      </div>
