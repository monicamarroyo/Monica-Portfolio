...
const MainSection = () => {
  return (
    <div className="px-5 mx-auto">
      <Fade bottom>
        <Row  className="px-auto mx-auto text-center" style={{height:"100vh"}}>
          <Col className="px-auto mx-auto">
            <Heading size={4} className="header-text_name text-center px-auto mx-auto">
              {" "}
              Monica Arroyo
            </Heading>
            <Heading
