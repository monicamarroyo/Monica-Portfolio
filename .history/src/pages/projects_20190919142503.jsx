  ...
  <Row className="Project_Section mx-auto px-auto">
    ...
    <Col md="auto" className="Project_Section--right text-center">
      ...
      <div className="Project_Desc">
        ...
        website as a starter website in order to learn ReactJs, mainly focusing
        on Front-End development. Since then I have continued to program in
        React, and it's a framework that I enjoy programming in.
      ...
      <div className="Project_Desc3">
        ...
        Developed a blogging application by using schemas, data types, queires, mutations, subscriptions in order to learn fudamentals of GraphQL. From there we integrated Primsa to store and access data from our Postgres database and developed an authenication system to secure 
        I learned fundamentals of GraphQL by building a blogging application. The
        Next, you’ll master the fundamentals of GraphQL by building out a
        blogging application. You’ll learn about GraphQL schemas, data types,
        queries, mutations, subscriptions, and many other fantastic GraphQL
        features. From there, you’ll set up advanced features like
        authentication, database storage, production deployment, automated test
        suites, and more
        <div className="Project_Dec--codeLink">
          <a
            href="https://github.com/monicamarroyo/Monica_Salon_React"
