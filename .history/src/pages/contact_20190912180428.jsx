...
const Contact = ({ data }) => (
  <Row className="Contact_Section mx-auto px-auto">
    ...
    >
      ...
      >
        <div className="Contact_Info">
          <h1 className="Contact_Info--text mx-auto my-auto px-auto py-auto">
            Contact
          </h1>
    ...
    >
      <div className="Contact_Section--form">
        <form id="email-form" name="email-form" data-name="Email Form">
          <label htmlFor="name" className="Contact-form-label mx-auto my-auto">
            Name:
          </label>
          <input
            type="text"
