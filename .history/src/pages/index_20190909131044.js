...
const IndexPage = ({ scrollTop, toggleSidebar, data }) => (
  <div>
    ...
    <main>
      <BackgroundImage Tag="section" style={{height:"100vh"}} fluid={data.bgImage.childImageSharp.fluid}>
        <Section bg id="home" padding={Section.PADDING_LARGE}>
          <MainSection />
        </Section>
      </BackgroundImage>

      <Section id="about-me" padding={Section.PADDING_LARGE}>
        <Container>
          <Pulse>
            <About />
          </Pulse>
      ...
      <Section id="projects" padding={Section.PADDING_LARGE}>
        <Container>
          <Pulse>
            <h1>projects</h1>
          </Pulse>
