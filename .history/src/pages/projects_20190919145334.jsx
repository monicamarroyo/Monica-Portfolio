...
const Projects = ({ data }) => (
  <Row className="Project_Section mx-auto px-auto">
    ...
    <Col md="auto" className="Project_Section--right text-center">
      <h4 className="Project_Text px-auto mx-auto">
      ...
      <div className="Project_Desc">
        ...
        mutations, subscriptions in order to learn fudamentals of
        GraphQL. Integrated Primsa to store and access data from our Postgres
        database and developed an authenication system to secure data. Created
        automated test suites using Jest, a created a client to interact with
        our application using Apollo.
