...
const Contact = ({ data }) => (
  <div style={{ padding: 0, margin: 0 }} className="Contact_Container">
    <Row style={{ padding: 0, margin: 0 }} className="Contact_Row">
      <Col md="6" style={{ padding: 0, margin: 0 }} className="left" />
      <Col md="6"style={{ padding: 0, margin: 0 }} className="right">
        Right
      </Col>
    </Row>
  </div>
