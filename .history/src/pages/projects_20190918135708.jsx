      ...
      >
        <div className="Project_Info">
          <Fade top>
            ...
            <h4 className="pt-3">Here's a few of the many things I've worked on over the year. Check out the projects source code for a deeper insight into how I work.</h4>
          </Fade>
        </div>
      </Col>
    </BackgroundImage>
