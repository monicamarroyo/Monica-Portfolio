...
const Contact = ({ data }) => (
  <Container style={{ padding: 0, margin: 0 }} className="Contact_Container">
    <Row style={{ padding: 0, margin: 0 }} className="Contact_Row">
      <BackgroundImage
        ...
        className="pine"
      >
        <Col style={{padding:0, margin:0}} className="left" md="6" />
      </BackgroundImage>
      <Col style={{padding:0, margin:0}} className="right" md="6">
        Right
      </Col>
    </Row>
  </Container>
...
const ContactSection = props => (
  <StaticQuery
    query={graphql`
      query MyQuery3 {
        pineapple: file(relativePath: { eq: "pineapple.jpg" }) {
          childImageSharp {
