...
const Sidebar = ({ isOpen, toggle }) => (
  ...
  >
    <NavScrollspy mapItems={({ name, href }) => (
      <AnchorLink
        className="Sidebar__link Sidebar__link_underline d-block "
        href={`#${href}`}
        key={name}
        onClick={toggle}
      >
    ...
    />
    <a className="Sidebar__link"  href="https://drive.google.com/file/d/1nbZps9HBHTAuDymwGDa5-lcCqPYURswW/view" target="_blank">
      Resume
    </a>
