    ...
    <Col md="auto" className="Project_Section--right text-center">
      <Fade right>
        <h4 className="Project_Text">
          Here's a few of the many things I've worked on over the year. Check
          out the source code for a deeper insight into how I work.
        </h4>
        <div className="Project_Desc">
          ...
          <div className="Project_Libraries text-center d-none d-xl-block d-lg-block">
            ...
            <SocialLink icon="docker" to="https://www.docker.com/" />
            <SocialLink icon="jest" to="https://jestjs.io/" />
